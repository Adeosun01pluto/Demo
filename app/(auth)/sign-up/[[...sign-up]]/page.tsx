...
//       <SignUp />;
//       <div className='bg-[#1f1f1f] p-8 w-[30%] min-h-[85vh] rounded-lg mx-auto'>
//         <div>
//           <p className="text-white text-[22px] font-semibold">Create your account</p>
...
//             <label htmlFor="" className="text-white text-[13px]">Username</label>
//             {/* @ts-ignore */}
//             <input value={username} onChange={(e)=>setUsername(e.target.value)} type="text" placeholder="Username" className="px-3 py-2 text-[13px] rounded-md border border-gray-600 text-white bg-transparent w-full " />
//           </div>
//           <div className="flex flex-col gap-2">
//             <label htmlFor="" className="text-white text-[13px]">Email address</label>
//             {/* @ts-ignore */}
...
//             <span>Have an account? </span> {' '} <span className="text-primary-500">Sign In</span>
//           </div>
//         </div>
