...
const ShowMore = ({ isNext , search, load}: any) => {
  ...
  return (
    <div ref={ref} className="w-full items-center flex justify-center gap-5 mt-10 mb-5">
      {loading && 
        <div role="status w-full">
          <svg aria-hidden="true" className="w-8 h-8 text-green-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
